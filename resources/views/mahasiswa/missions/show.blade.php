...
<div style="padding:2rem 0;">
    ...
    {{-- Back button --}}
    <a href="{{ route('mahasiswa.missions.browse') }}" style="display:inline-flex;align-items:center;gap:6px;font-size:.825rem;color: #475569;text-decoration:none;margin-bottom:1.5rem;transition:color .2s;" onmouseover="this.style.color='#1E45FB'" onmouseout="this.style.color='#475569'">
        ...
        <div style="display:flex;flex-direction:column;gap:1.5rem;">
            ...
            <div class="glass-card" style="padding:2rem;">
                <div style="display:flex;flex-wrap:wrap;align-items:center;gap:.625rem;margin-bottom:1.25rem;">
                    ...
                    <span style="margin-left:auto;font-size:.9rem;font-weight:800;color:#1E45FB;display:flex;align-items:center;gap:5px;">
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="#1E45FB"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
        ...
        <div style="display:flex;flex-direction:column;gap:1.25rem;position:sticky;top:90px;">
            ...
            <div class="glass-card" style="padding:1.5rem;">
                ...
                <div style="display:flex;align-items:center;gap:.875rem;margin-bottom:1rem;">
                    ...
                    <div>
                        <a href="{{ route('profiles.show', $mission->creator) }}" style="font-size:.9rem;font-weight:700;color:#0F172A;text-decoration:none;" onmouseover="this.style.color='#1E45FB'" onmouseout="this.style.color='#0F172A'">{{ $mission->creator->umkmProfile?->business_name ?? $mission->creator->name }}</a>
